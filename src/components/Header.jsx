  ...
  return (
    <header className="header">
      <div className="header-logo">
        ...
        <div>
          ...
          <div className="logo-sub">
            {patientName ? `Patient: ${patientName}` : "Ambient AI Clinical Scribe"}
          </div>
        </div>
      </div>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
        ...
        >
          {hospitalName ? `🏥 ${hospitalName}` : "🔗 Link Hospital"}
        </button>
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: "2px" }}>
          ...
          <button onClick={onSignOut}
            style={{ fontSize: "11px", color: "var(--text3)", background: "transparent", border: "none", cursor: "pointer", padding: 0, fontFamily: "var(--font)", textDecoration: "underline" }}>
            Sign out
          </button>
        </div>
      </div>
